    ...
    <div className="rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
      <div className="flex items-center gap-4">
        <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-full">
          <AgentAvatar photo={photo} name={name} sizes="64px" />
        </div>
        <div>
      ...
      <div className="mt-5 grid grid-cols-3 gap-2">
        <a
          ...
          className="flex flex-col items-center gap-1.5 rounded-lg border border-gray-200 py-3 text-ink-900 transition hover:border-gold-500 hover:text-gold-700"
        >
        ...
        <a
          ...
          className="flex flex-col items-center gap-1.5 rounded-lg border border-gray-200 py-3 text-ink-900 transition hover:border-[#25D366] hover:text-[#25D366]"
        >
